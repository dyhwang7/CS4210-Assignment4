...
# SPECIFICATION: finding the best hyperparameters for each classifier
        ...
        for a in range(2): #iterates over the algorithms
            ...
            if a == 0:
                if accuracy > p_max_accuracy:
                    ...
                    print("Highest Perceptron accuracy so far: {}, Parameters: learning rate = {}, shuffle = {}".format(p_max_accuracy, w, b))
            else:
